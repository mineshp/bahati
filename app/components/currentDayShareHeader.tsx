      ...
      >
        <div className="...">
          <div
            ...
            data-cy="share-logo-name"
          >
            {shareCode.substring(0, 4).replace(".L", "").replace(".", "")}
          </div>
        </div>
        <div
          className="... row-span-2 content-center items-center justify-center justify-items-center self-center text-center"
        ...
        <div className="... flex flex-row justify-end" data-cy="day-high">
          <Pill data={data.dayHigh} currency={data.currency} type="high" />
        </div>
        <div className="... relative" data-cy="exchange">
        ...
        <div className="... flex flex-row justify-end" data-cy="day-low">
